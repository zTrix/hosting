...
!function(a,b){function c(){var b=a.navigator.userAgent,c=b.indexOf("MSIE "),d=b.indexOf("Trident/");if(c>0)return parseInt(b.substring(c+5,b.indexOf(".",c)),10);if(d>0){var e=b.indexOf("rv:");return parseInt(b.substring(e+3,b.indexOf(".",e)),10)}return!1}function d(a,b,d){var e=u.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(c()&&(e=e.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)u[b]="",b--;u[a]="@@@@"+z.length+"@@@@",d&&(e=d(e)),z.push(e),v=w=x=null}function e(a){v=w=x=null,z=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},u=A(a.replace(/\r\n?/g,"\n"),B);for(var c=1,e=u.length;e>c;c+=2){var f=u[c];"@"===f.charAt(0)?(u[c]="@@@@"+z.length+"@@@@",z.push(f)):v?"$"==w&&f.match(/\n/)?(x&&(c=x,d(v,c,b)),v=w=x=null,y=0):f===w?y?x=c:d(v,c,b):f.match(/\n.*\n/)?(x&&(c=x,d(v,c,b)),v=w=x=null,y=0):"{"===f?y++:"}"===f&&y&&y--:"$"===f||"$$"===f?(v=c,w=f,y=0):"begin"===f.substr(1,5)&&(v=c,w="\\end"+f.substr(6),y=0)}return x&&d(v,x,b),b(u.join(""))}function f(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return z[b]}),z=null,a}b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var g=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],h=b.getElementsByTagName("title")[0],i=b.getElementsByTagName("script"),j=b.getElementsByClassName("navbar")[0];if(!g)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdownjs.com/ to learn more.");b.body.style.display="none";var k=b.createElement("meta");k.name="viewport",k.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(k,b.head.firstChild):b.head.appendChild(k);for(var l="",m=0;m<i.length;m++)i[m].src.match("strapdown")&&(l=i[m].src);var n=l.substr(0,l.lastIndexOf("/")),o=g.getAttribute("theme")||"cerulean";o=o.toLowerCase();var p=b.createElement("link");p.href=n+"/themes/"+o+".min.css",p.rel="stylesheet",b.head.appendChild(p);var p=b.createElement("link");p.href=n+"/strapdown.min.css",p.rel="stylesheet",b.head.appendChild(p);var p=b.createElement("link");p.href=n+"/themes/bootstrap-responsive.min.css",p.rel="stylesheet",b.head.appendChild(p);var q=g.textContent||g.innerText,r=b.createElement("div");r.className="container",r.id="content",b.body.replaceChild(r,g);var r=b.createElement("div");if(r.className="navbar navbar-fixed-top",!j&&h){r.innerHTML='<div class="navbar-inner"> <div class="container"> <div id="headline" class="brand"> </div> </div> </div>',b.body.insertBefore(r,b.body.firstChild);var s=h.innerHTML,t=b.getElementById("headline");t&&(t.innerHTML=s)}var u,v,w,x,y,z,A,B=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;A=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var C=e(q),D=marked(C),E=f(D);if(b.getElementById("content").innerHTML=E,E!=D){var F=b.createElement("script");F.type="text/javascript",F.src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG";var G=function(){MathJax.Ajax.timeout=6e4,MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none",SVG:{styles:{".MathJax_SVG svg > g, .MathJax_SVG_Display svg > g":{fill:"#333333",stroke:"#333333"}},scale:100}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub])};F.onload=G,F.onreadystatechange=function(){"complete"==this.readyState&&G()},b.getElementsByTagName("head")[0].appendChild(F)}if("hljs"in a){for(var H=b.getElementsByTagName("code"),m=0,I=H.length;I>m;m++){var J=H[m],K=J.className;"pre"==J.parentNode.nodeName.toLowerCase()&&(J.parentNode.className="code-wrapper "+K)}hljs.initHighlightingOnLoad()}else if("prettyPrint"in a){for(var H=b.getElementsByTagName("code"),m=0,I=H.length;I>m;m++){var J=H[m],K=J.className;"pre"==J.parentNode.nodeName.toLowerCase()&&(J.parentNode.className="code-wrapper prettyprint "+K)}prettyPrint()}for(var L=b.getElementsByTagName("table"),m=0,I=L.length;I>m;m++){var M=L[m];M.className="table table-striped table-bordered"}b.body.style.display=""}(window,document);