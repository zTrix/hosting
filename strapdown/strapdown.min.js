...
!function(a,b){var c=new Persist.Store("strapdown",{swf_path:"/persist.swf"});c.get("theme",function(d,e){function f(a,b,c){return a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,!1)}function g(){var b=a.navigator.userAgent,c=b.indexOf("MSIE "),d=b.indexOf("Trident/");if(c>0)return parseInt(b.substring(c+5,b.indexOf(".",c)),10);if(d>0){var e=b.indexOf("rv:");return parseInt(b.substring(e+3,b.indexOf(".",e)),10)}return!1}function h(a,b,c){var d=B.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(g()&&(d=d.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)B[b]="",b--;B[a]="@@@@"+G.length+"@@@@",c&&(d=c(d)),G.push(d),C=D=E=null}function i(a){C=D=E=null,G=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},B=H(a.replace(/\r\n?/g,"\n"),I);for(var c=1,d=B.length;d>c;c+=2){var e=B[c];"@"===e.charAt(0)?(B[c]="@@@@"+G.length+"@@@@",G.push(e)):C?"$"==D&&e.match(/\n/)?(E&&(c=E,h(C,c,b)),C=D=E=null,F=0):e===D?F?E=c:h(C,c,b):e.match(/\n.*\n/)?(E&&(c=E,h(C,c,b)),C=D=E=null,F=0):"{"===e?F++:"}"===e&&F&&F--:"$"===e||"$$"===e?(C=c,D=e,F=0):"begin"===e.substr(1,5)&&(C=c,D="\\end"+e.substr(6),F=0)}return E&&h(C,E,b),b(B.join(""))}function j(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return G[b]}),G=null,a}var k=null;d&&(k=e),b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var l=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],m=b.getElementsByTagName("title")[0],n=b.getElementsByTagName("script"),o=b.getElementsByClassName("navbar")[0];if(!l)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdown.ztx.io/ to learn more.");b.body.style.display="none";var p=b.createElement("meta");p.name="viewport",p.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(p,b.head.firstChild):b.head.appendChild(p);for(var q="",r=0;r<n.length;r++)n[r].src.match("strapdown")&&(q=n[r].src);var s=q.substr(0,q.lastIndexOf("/"));k=k||l.getAttribute("theme")||"cerulean",k=k.toLowerCase();var t=b.createElement("link");t.href=s+"/themes/"+k+".min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=s+"/strapdown.min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=s+"/themes/bootstrap-responsive.min.css",t.rel="stylesheet",b.head.appendChild(t);var u=l.textContent||l.innerText,v=b.createElement("div");v.className="container",v.id="content",b.body.replaceChild(v,l);var v=b.createElement("div");if(v.className="navbar navbar-fixed-top",!o&&m){v.innerHTML='<div class="navbar-inner"> <div class="container"><a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-responsive-collapse"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a><div id="headline" class="brand"> </div><div class="nav-collapse collapse navbar-responsive-collapse pull-right"> <ul class="nav"><li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">Theme<b class="caret"></b></a><ul class="dropdown-menu" id="theme"></ul></li></ul> </div></div> </div>',b.body.insertBefore(v,b.body.firstChild);var w=m.innerHTML,x=b.getElementById("headline");x&&(x.innerHTML=w);var y=b.getElementById("theme");if(y){var z=["Amelia","Bootstrap","Cerulean","Cosmo","Cyborg","Flatly","Journal","Readable","Simplex","Slate","Spacelab","Spruce","Superhero","United","Reset"];z.forEach(function(a){if("Reset"==a){var d=b.createElement("li");d.setAttribute("class","divider"),y.appendChild(d)}var e=b.createElement("li"),g=b.createElement("a");"undefined"!=typeof g.textContent?g.textContent=a:g.innerText=a,g.setAttribute("href","#"),e.appendChild(g),f(g,"click",function(){"Reset"==a?c.set("theme",""):c.set("theme",a),location.reload()}),y.appendChild(e)})}var A=b.getElementsByClassName("dropdown")[0];y&&A&&f(A,"click",function(){A.className.match(/(?:^|\s)open(?!\S)/)?A.className=A.className.replace(/(?:^|\s)open(?!\S)/g,""):A.className+=" open"})}var B,C,D,E,F,G,H,I=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;H=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var J=[],K=[0,0,0,0,0,0],L=l.getAttribute("heading_number"),M=["i","i","i","i","i","i"];if(L&&"none"!=L&&"false"!=L)for(var N=L.split("."),r=0;6>r;r++)"a"==N[r]&&(M[r]="a");var O=function(a,b){return"a"==M[b]&&26>=a?String.fromCharCode(96+a):""+a},P=function(a){for(var b=5,c=""+O(a[0],0);b>=0&&!a[b];b--);for(var d=1;b>=d;d++)c+="."+O(a[d],d);return c},J=[],Q=new marked.Renderer;Q.heading=function(a,b){K[b-1]++;for(var c=b;6>c;c++)K[c]=0;var d,e=P(K),f="h"+e+"_"+a.toLowerCase().replace(/[^-_.\w\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/g,"-");d=L&&"none"!=L&&"false"!=L?e+" ":"";for(var g=J,c=0;b-1>c;c++)0!=g.length&&Array.isArray(g[g.length-1])||g.push([]),g=g[g.length-1];return g.push({target:"#"+f,title:d+a}),"<h"+b+' style="position:relative;"><a name="'+f+'" class="anchor" href="#'+f+'"><span class="header-link"></span></a>'+d+a+"</h"+b+">"};var R=i(u),S=marked(R,{renderer:Q}),T=j(S),U=l.getAttribute("toc");if("true"==U){var V=b.createElement("ul"),W=function(a,c){for(var d=0;d<a.length;d++){var e;if(Array.isArray(a[d]))e=b.createElement("ul"),W(a[d],e);else{e=b.createElement("li");var f=b.createElement("a");f.setAttribute("href",a[d].target),f.appendChild(b.createTextNode(a[d].title)),e.appendChild(f)}c.appendChild(e)}};W(J,V);var X=b.createElement("div");X.className="container";var w=b.createElement("h1");w.appendChild(b.createTextNode("Table of Content")),X.appendChild(w),X.appendChild(b.createElement("hr")),X.appendChild(V),X.appendChild(b.createElement("hr")),b.body.insertBefore(X,b.getElementById("content"))}if(b.getElementById("content").innerHTML=T,T!=S){var Y=b.createElement("script");Y.type="text/javascript",Y.src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG";var Z=function(){MathJax.Ajax.timeout=6e4,MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none",SVG:{styles:{".MathJax_SVG svg > g, .MathJax_SVG_Display svg > g":{fill:"#4d4d4c",stroke:"#4d4d4c"}},scale:100}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub])};Y.onload=Z,Y.onreadystatechange=function(){"complete"==this.readyState&&Z()},b.getElementsByTagName("head")[0].appendChild(Y)}if("hljs"in a){for(var $=b.getElementsByTagName("code"),r=0,_=$.length;_>r;r++){var aa=$[r],ba=aa.className;"pre"==aa.parentNode.nodeName.toLowerCase()&&(aa.parentNode.className="code-wrapper "+ba)}hljs.initHighlightingOnLoad()}else if("prettyPrint"in a){for(var $=b.getElementsByTagName("code"),r=0,_=$.length;_>r;r++){var aa=$[r],ba=aa.className;"pre"==aa.parentNode.nodeName.toLowerCase()&&(aa.parentNode.className="code-wrapper prettyprint "+ba)}prettyPrint()}for(var ca=b.getElementsByTagName("table"),r=0,_=ca.length;_>r;r++){var da=ca[r];da.className="table table-striped table-bordered"}b.body.style.display=""})}(window,document);