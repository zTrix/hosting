...
!function(a,b){function c(){var b=a.navigator.userAgent,c=b.indexOf("MSIE "),d=b.indexOf("Trident/");if(c>0)return parseInt(b.substring(c+5,b.indexOf(".",c)),10);if(d>0){var e=b.indexOf("rv:");return parseInt(b.substring(e+3,b.indexOf(".",e)),10)}return!1}function d(a,b,d){var e=k.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(c()&&(e=e.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)k[b]="",b--;k[a]="@@@@"+y.length+"@@@@",d&&(e=d(e)),y.push(e),q=o=l=null}function e(a){q=o=l=null,y=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},k=z(a.replace(/\r\n?/g,"\n"),A);for(var a=1,c=k.length;c>a;a+=2){var e=k[a];"@"===e.charAt(0)?(k[a]="@@@@"+y.length+"@@@@",y.push(e)):q?e===o?n?l=a:d(q,a,b):e.match(/\n.*\n/)?(l&&(a=l,d(q,a,b)),q=o=l=null,n=0):"{"===e?n++:"}"===e&&n&&n--:"$"===e||"$$"===e?(q=a,o=e,n=0):"begin"===e.substr(1,5)&&(q=a,o="\\end"+e.substr(6),n=0)}return l&&d(q,l,b),ret=b(k.join(""))}function f(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return y[b]}),y=null,a}b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var g=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],h=b.getElementsByTagName("title")[0],i=b.getElementsByTagName("script"),j=b.getElementsByClassName("navbar")[0];if(!g)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdownjs.com/ to learn more.");b.body.style.display="none";var m=b.createElement("meta");m.name="viewport",m.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(m,b.head.firstChild):b.head.appendChild(m);for(var p="",q=0;q<i.length;q++)i[q].src.match("strapdown")&&(p=i[q].src);var r=p.substr(0,p.lastIndexOf("/")),s=g.getAttribute("theme")||"bootstrap";s=s.toLowerCase();var t=b.createElement("link");t.href=r+"/themes/"+s+".min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=r+"/strapdown.min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=r+"/themes/bootstrap-responsive.min.css",t.rel="stylesheet",b.head.appendChild(t);var u=g.textContent||g.innerText,v=b.createElement("div");v.className="container",v.id="content",b.body.replaceChild(v,g);var v=b.createElement("div");if(v.className="navbar navbar-fixed-top",!j&&h){v.innerHTML='<div class="navbar-inner"> <div class="container"> <div id="headline" class="brand"> </div> </div> </div>',b.body.insertBefore(v,b.body.firstChild);var w=h.innerHTML,x=b.getElementById("headline");x&&(x.innerHTML=w)}var y,z,A=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;z=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var B=e(u),C=marked(B),D=f(C);if(b.getElementById("content").innerHTML=D,D!=C){var E=b.createElement("script");E.type="text/javascript",E.src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS_HTML";var F=function(){MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none"})};E.onload=F,E.onreadystatechange=function(){"complete"==this.readyState&&F()},b.getElementsByTagName("head")[0].appendChild(E)}for(var G=b.getElementsByTagName("code"),q=0,H=G.length;H>q;q++){var I=G[q],J=I.className;I.className="prettyprint lang-"+J}prettyPrint();for(var K=b.getElementsByTagName("table"),q=0,H=K.length;H>q;q++){var L=K[q];L.className="table table-striped table-bordered"}b.body.style.display=""}(window,document);