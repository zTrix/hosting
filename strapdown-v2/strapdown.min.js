...
!function(a,b){var c=new Persist.Store("strapdown",{swf_path:"/persist.swf"});c.get("theme",function(d,e){function f(a,b,c){return a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,!1)}function g(){var b=a.navigator.userAgent,c=b.indexOf("MSIE "),d=b.indexOf("Trident/");if(c>0)return parseInt(b.substring(c+5,b.indexOf(".",c)),10);if(d>0){var e=b.indexOf("rv:");return parseInt(b.substring(e+3,b.indexOf(".",e)),10)}return!1}function h(a,b,c){var d=D.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(g()&&(d=d.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)D[b]="",b--;D[a]="@@@@"+I.length+"@@@@",c&&(d=c(d)),I.push(d),E=F=G=null}function i(a){E=F=G=null,I=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},D=J(a.replace(/\r\n?/g,"\n"),K);for(var c=1,d=D.length;d>c;c+=2){var e=D[c];"@"===e.charAt(0)?(D[c]="@@@@"+I.length+"@@@@",I.push(e)):E?"$"==F&&e.match(/\n/)?(G&&(c=G,h(E,c,b)),E=F=G=null,H=0):e===F?H?G=c:h(E,c,b):e.match(/\n.*\n/)?(G&&(c=G,h(E,c,b)),E=F=G=null,H=0):"{"===e?H++:"}"===e&&H&&H--:"$"===e||"$$"===e?(E=c,F=e,H=0):"begin"===e.substr(1,5)&&(E=c,F="\\end"+e.substr(6),H=0)}return G&&h(E,G,b),b(D.join(""))}function j(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return I[b]}),I=null,a}var k=null;d&&(k=e),b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var l=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],m=b.getElementsByTagName("title")[0],n=b.getElementsByTagName("script"),o=b.getElementsByClassName("navbar")[0];if(!l)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdown.ztx.io/ to learn more.");b.body.style.display="none";var p=b.createElement("meta");p.name="viewport",p.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(p,b.head.firstChild):b.head.appendChild(p);for(var q="",r=0;r<n.length;r++)n[r].src.match("strapdown")&&(q=n[r].src);var s=q.substr(0,q.lastIndexOf("/"));k=k||l.getAttribute("theme")||"cerulean",k=k.toLowerCase();var t=b.createElement("link");t.href=s+"/themes/"+k+".min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=s+"/strapdown.min.css",t.rel="stylesheet",b.head.appendChild(t);var t=b.createElement("link");t.href=s+"/themes/bootstrap-responsive.min.css",t.rel="stylesheet",b.head.appendChild(t);var u=l.textContent||l.innerText,v=b.createElement("div");v.className="container",v.id="content",b.body.replaceChild(v,l);var v=b.createElement("div");if(v.className="navbar navbar-fixed-top",v.className+=l.getAttribute("edit")?" edit":"",v.className+=l.getAttribute("history")?" history":"",!o&&m){v.innerHTML='<div class="navbar-inner"> <div class="container"><a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-responsive-collapse"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a><div id="headline" class="brand"> </div><div class="nav-collapse collapse navbar-responsive-collapse"> <ul class="nav pull-right"><li class="history-link"><a href="?history">History</a></li><li class="edit-link"><a href="?edit">Edit</a> </li><li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">Theme<b class="caret"></b></a><ul class="dropdown-menu" id="theme"></ul></li></ul> </div></div> </div>',b.body.insertBefore(v,b.body.firstChild);var w=m.innerHTML,x=b.getElementById("headline");x&&(x.innerHTML=w);var y=b.getElementById("theme");if(y){var z=["Amelia","Bootstrap","Cerulean","Cosmo","Cyborg","Flatly","Journal","Readable","Simplex","Slate","Spacelab","Spruce","Superhero","United","Reset"];z.forEach(function(a){if("Reset"==a){var d=b.createElement("li");d.setAttribute("class","divider"),y.appendChild(d)}var e=b.createElement("li"),g=b.createElement("a");"undefined"!=typeof g.textContent?g.textContent=a:g.innerText=a,g.setAttribute("href","#"),e.appendChild(g),f(g,"click",function(){"Reset"==a?c.set("theme",""):c.set("theme",a),location.reload()}),y.appendChild(e)})}var A=b.getElementsByClassName("dropdown")[0],B=b.getElementsByClassName("btn-navbar")[0],C=b.getElementsByClassName("navbar-responsive-collapse")[0];y&&A&&(f(A,"click",function(){A.className.match(/(?:^|\s)open(?!\S)/)?A.className=A.className.replace(/(?:^|\s)open(?!\S)/g,""):A.className+=" open"}),f(B,"click",function(){C.style.height=C.style.height?"":"auto"}))}var D,E,F,G,H,I,J,K=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;J=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var L=[],M=[0,0,0,0,0,0],N=l.getAttribute("heading_number"),O=["i","i","i","i","i","i"];if(N&&"none"!=N&&"false"!=N)for(var P=N.split("."),r=0;6>r;r++)"a"==P[r]&&(O[r]="a");var Q=function(a,b){return"a"==O[b]&&26>=a?String.fromCharCode(96+a):""+a},R=function(a){for(var b=5,c=""+Q(a[0],0);b>=0&&!a[b];b--);for(var d=1;b>=d;d++)c+="."+Q(a[d],d);return c},L=[],S=new marked.Renderer;S.heading=function(a,b){M[b-1]++;for(var c=b;6>c;c++)M[c]=0;var d,e=R(M),f="h"+e+"_"+a.toLowerCase().replace(/[^-_.\w\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/g,"-");d=N&&"none"!=N&&"false"!=N?e+" ":"";for(var g=L,c=0;b-1>c;c++)0!=g.length&&Array.isArray(g[g.length-1])||g.push([]),g=g[g.length-1];return g.push({target:"#"+f,title:d+a}),"<h"+b+' style="position:relative;"><a name="'+f+'" class="anchor" href="#'+f+'"><span class="header-link"></span></a>'+d+a+"</h"+b+">"};var T=i(u),U=marked(T,{renderer:S}),V=j(U),W=l.getAttribute("toc");if("true"==W){var X=b.createElement("ul"),Y=function(a,c){for(var d=0;d<a.length;d++){var e;if(Array.isArray(a[d]))e=b.createElement("ul"),Y(a[d],e);else{e=b.createElement("li");var f=b.createElement("a");f.setAttribute("href",a[d].target),f.appendChild(b.createTextNode(a[d].title)),e.appendChild(f)}c.appendChild(e)}};Y(L,X);var Z=b.createElement("div");Z.className="container";var w=b.createElement("h1");w.appendChild(b.createTextNode("Table of Content")),Z.appendChild(w),Z.appendChild(b.createElement("hr")),Z.appendChild(X),Z.appendChild(b.createElement("hr")),b.body.insertBefore(Z,b.getElementById("content"))}if(b.getElementById("content").innerHTML=V,V!=U){var $=b.createElement("script");$.type="text/javascript",$.src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG";var _=function(){MathJax.Ajax.timeout=6e4,MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none",SVG:{styles:{".MathJax_SVG svg > g, .MathJax_SVG_Display svg > g":{fill:"#4d4d4c",stroke:"#4d4d4c"}},scale:100}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub])};$.onload=_,$.onreadystatechange=function(){"complete"==this.readyState&&_()},b.getElementsByTagName("head")[0].appendChild($)}if("hljs"in a){for(var aa=b.getElementsByTagName("code"),r=0,ba=aa.length;ba>r;r++){var ca=aa[r],da=ca.className;"pre"==ca.parentNode.nodeName.toLowerCase()&&(ca.parentNode.className="code-wrapper "+da)}hljs.initHighlightingOnLoad()}else if("prettyPrint"in a){for(var aa=b.getElementsByTagName("code"),r=0,ba=aa.length;ba>r;r++){var ca=aa[r],da=ca.className;"pre"==ca.parentNode.nodeName.toLowerCase()&&(ca.parentNode.className="code-wrapper prettyprint "+da)}prettyPrint()}for(var ea=b.getElementsByTagName("table"),r=0,ba=ea.length;ba>r;r++){var fa=ea[r];fa.className="table table-striped table-bordered"}b.body.style.display=""})}(window,document);