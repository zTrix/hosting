...
function addEvent(a,b,c){return a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,!1)}function setInnerText(a,b){"undefined"!=typeof a.textContent?a.textContent=b:a.innerText=b}function getScriptBase(a){for(var b="",c=document.getElementsByTagName("script"),d=0;d<c.length;d++)c[d].src.match(a)&&(b=c[d].src);return b.substr(0,b.lastIndexOf("/"))}function upsertTheme(a,b){for(var c=!1,d=document.getElementsByTagName("link"),e=d.length-1;e>=0;e--)if("stylesheet"==d[e].rel&&d[e].href.match(a+"/themes/")){d[e].href=a+"/themes/"+b+".min.css",c=!0;break}if(!c){var f=document.createElement("link");f.href=a+"/themes/"+b+".min.css",f.rel="stylesheet",document.head.appendChild(f)}}function render(a,b,c,d,e){function f(){var a=window.navigator.userAgent,b=a.indexOf("MSIE "),c=a.indexOf("Trident/");if(b>0)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);if(c>0){var d=a.indexOf("rv:");return parseInt(a.substring(d+3,a.indexOf(".",d)),10)}return!1}function g(a,b,c){var d=j.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(f()&&(d=d.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)j[b]="",b--;j[a]="@@@@"+o.length+"@@@@",c&&(d=c(d)),o.push(d),k=l=m=null}function h(a){k=l=m=null,o=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},j=p(a.replace(/\r\n?/g,"\n"),q);for(var c=1,d=j.length;d>c;c+=2){var e=j[c];"@"===e.charAt(0)?(j[c]="@@@@"+o.length+"@@@@",o.push(e)):k?"$"==l&&e.match(/\n/)?(m&&(c=m,g(k,c,b)),k=l=m=null,n=0):e===l?n?m=c:g(k,c,b):e.match(/\n.*\n/)?(m&&(c=m,g(k,c,b)),k=l=m=null,n=0):"{"===e?n++:"}"===e&&n&&n--:"$"===e||"$$"===e?(k=c,l=e,n=0):"begin"===e.substr(1,5)&&(k=c,l="\\end"+e.substr(6),n=0)}return m&&g(k,m,b),b(j.join(""))}function i(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return o[b]}),o=null,a}var j,k,l,m,n,o,p,q=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;p=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var r=[],s=[0,0,0,0,0,0],t=["i","i","i","i","i","i"];if(d&&"none"!=d&&"false"!=d)for(var u=d.split("."),v=0;6>v;v++)"a"==u[v]&&(t[v]="a");var w=function(a,b){return"a"==t[b]&&26>=a?String.fromCharCode(96+a):""+a},x=function(a){for(var b=5,c=""+w(a[0],0);b>=0&&!a[b];b--);for(var d=1;b>=d;d++)c+="."+w(a[d],d);return c},r=[],y=new marked.Renderer;y.heading=function(a,b){s[b-1]++;for(var c=b;6>c;c++)s[c]=0;var e,f=x(s),g="h"+f+"_"+a.toLowerCase().replace(/[^-_.\w\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/g,"-");e=d&&"none"!=d&&"false"!=d?f+" ":"";for(var h=r,c=0;b-1>c;c++)0!=h.length&&Array.isArray(h[h.length-1])||h.push([]),h=h[h.length-1];return h.push({target:"#"+g,title:e+a}),"<h"+b+' style="position:relative;"><a name="'+g+'" class="anchor" href="#'+g+'"><span class="header-link"></span></a>'+e+a+"</h"+b+">"};var z=h(b),A=marked(z,{renderer:y}),B=i(A);if("true"==e){var C=document.createElement("ul"),D=function(a,b){for(var c=0;c<a.length;c++){var d;if(Array.isArray(a[c]))d=document.createElement("ul"),D(a[c],d);else{d=document.createElement("li");var e=document.createElement("a");e.setAttribute("href",a[c].target),e.appendChild(document.createTextNode(a[c].title)),d.appendChild(e)}b.appendChild(d)}};D(r,C);var E=document.createElement("div");E.className="container";var F=document.createElement("h1");F.appendChild(document.createTextNode("Table of Content")),E.appendChild(F),E.appendChild(document.createElement("hr")),E.appendChild(C),E.appendChild(document.createElement("hr")),document.body.insertBefore(E,document.getElementById("content"))}if(document.getElementById("content").innerHTML=B,B!=A)if(window.MathJax)MathJax.Hub.Queue(["Typeset",MathJax.Hub,a]);else{var G=document.createElement("script");G.type="text/javascript",G.src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG";var H=function(){MathJax.Ajax.timeout=6e4,MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none",SVG:{styles:{".MathJax_SVG svg > g, .MathJax_SVG_Display svg > g":{fill:"#4d4d4c",stroke:"#4d4d4c"}},scale:100}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub,a])};G.onload=H,G.onreadystatechange=function(){"complete"==this.readyState&&H()},document.getElementsByTagName("head")[0].appendChild(G)}if("hljs"in window)for(var I=document.getElementsByTagName("code"),v=0,J=I.length;J>v;v++){var K=I[v],L=K.className;"pre"==K.parentNode.nodeName.toLowerCase()&&(K.parentNode.className="code-wrapper "+L,hljs.highlightBlock(K))}else if("prettyPrint"in window){for(var I=document.getElementsByTagName("code"),v=0,J=I.length;J>v;v++){var K=I[v],L=K.className;"pre"==K.parentNode.nodeName.toLowerCase()&&(K.parentNode.className="code-wrapper prettyprint "+L)}prettyPrint()}for(var M=document.getElementsByTagName("table"),v=0,J=M.length;J>v;v++){var N=M[v];N.className="table table-striped table-bordered"}}
!function(a,b){console.log("!");var c=new Persist.Store("strapdown_editor",{swf_path:"/persist.swf"}),d=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],e=d.getAttribute("version"),f=a.location.pathname+"#"+e,g=c.get(f),h=ace.edit("editor"),i=h.getSession();h.setTheme("ace/theme/monokai"),i.setMode("ace/mode/markdown"),i.setTabSize(2),i.setUseSoftTabs(!0);var j=b.getElementsByTagName("title")[0].innerText,k=b.getElementById("headline");k&&(k.innerHTML=j),g&&g!=h.getValue()?(confirm("Detected unsaved document cache, do you want to load the cache?")&&i.setValue(g),c.remove(f)):c.remove(f);var l=b.getElementById("savValue"),m=b.getElementsByTagName("form")[0],n=b.getElementsByClassName("navbar-toggle")[0],o=b.getElementsByClassName("navbar-collapse")[0];addEvent(m,"submit",function(){l.value=h.getValue(),c.set(f,i.getValue())}),addEvent(n,"click",function(){var a=o.className.split(" ");a.indexOf("collapse")>-1?a.splice(a.indexOf("collapse"),1):a.push("collapse"),o.className=a.join(" ")});var p=Date.now()-2e3;h.on("change",function(a){var b=Date.now();b-p>2e3&&(c.set(f,i.getValue()),p=b)}),addEvent(b.getElementsByTagName("body")[0],"unload",function(){c.set(f,i.getValue())});var q=b.getElementsByClassName("render-target")[0],r=new Persist.Store("strapdown",{swf_path:"/persist.swf"}),s=r.get("theme")||"chaitin",t=b.getElementById("preview-toggle");addEvent(t,"click",function(){if("none"==q.style.display){d.style.display="none";var a=b.createElement("div"),c=i.getValue();a.className="container",a.id="content",q.innerHTML="",q.appendChild(a),render(a,c,s,null,!1),q.style.display="block",setInnerText(t,"Continue Editing")}else q.style.display="none",d.style.display="block",setInnerText(t,"Instant Preview"),b.getElementsByTagName("textarea")[0].focus()})}(window,document);