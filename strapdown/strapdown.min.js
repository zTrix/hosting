...
!function(a,b){var c=new Persist.Store("strapdown",{swf_path:"/persist.swf"});b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var d=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],e=b.getElementsByTagName("title")[0],f=b.getElementsByClassName("navbar")[0];if(!d)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdown.ztx.io/ to learn more.");b.body.style.display="none";var g=b.createElement("meta");g.name="viewport",g.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(g,b.head.firstChild):b.head.appendChild(g);var h=c.get("theme")||d.getAttribute("theme")||"chaitin";h=h.toLowerCase();var i=getScriptBase("strapdown");upsertTheme(i,h);var j=b.createElement("link");j.href=i+"/strapdown.min.css",j.rel="stylesheet",b.head.appendChild(j);var k=b.createElement("div");k.className="container",k.id="content",b.body.replaceChild(k,d);var k=b.createElement("div");if(k.className="navbar navbar-default navbar-fixed-top",k.className+=d.getAttribute("edit")?" edit":"",k.className+=d.getAttribute("history")?" history":"",!f&&e){k.innerHTML='<div class="container"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#main-nav" aria-expand="false"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><div class="navbar-brand" id="headline">Wiki</div></div><div class="collapse navbar-collapse"><ul class="nav navbar-nav navbar-right"><li class="history-link"><a href="?history">History</a></li><li class="edit-link"><a href="?edit">Edit</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Themes <span class="caret"></span></a><ul class="dropdown-menu" id="theme"></ul></li></ul></div></div>',b.body.insertBefore(k,b.body.firstChild);var l=e.innerHTML,m=b.getElementById("headline");m&&(m.innerHTML=l);var n=b.getElementById("theme");if(n){var o=["Chaitin","Cerulean","Cosmo","Cyborg","Darkly","Flatly","Journal","Lumen","Paper","Readable","Sandstone","Simplex","Slate","Spacelab","Superhero","United","Yeti"];o.forEach(function(a){if("Reset"==a){var d=b.createElement("li");d.setAttribute("class","divider"),n.appendChild(d)}var e=b.createElement("li"),f=b.createElement("a");setInnerText(f,a),f.setAttribute("href","#"),e.appendChild(f),a.toLowerCase()==h&&(e.className="active"),addEvent(f,"click",function(d){var e=a.toLowerCase();upsertTheme(i,e);var f=b.querySelectorAll("li.active");[].forEach.call(f,function(a){a.className=""}),d.target.parentNode.className="active",c.set("theme",e)}),n.appendChild(e)})}var p=b.getElementsByClassName("dropdown")[0],q=b.getElementsByClassName("navbar-toggle")[0],r=b.getElementsByClassName("navbar-collapse")[0];n&&p&&(addEvent(p,"click",function(){p.className.match(/(?:^|\s)open(?!\S)/)?p.className=p.className.replace(/(?:^|\s)open(?!\S)/g,""):p.className+=" open"}),addEvent(q,"click",function(){var a=r.className.split(" ");a.indexOf("collapse")>-1?a.splice(a.indexOf("collapse"),1):a.push("collapse"),r.className=a.join(" ")}))}var s=d.textContent||d.innerText,t=d.getAttribute("heading_number"),u=d.getAttribute("toc");render(k,s,h,t,u),b.body.style.display=""}(window,document);